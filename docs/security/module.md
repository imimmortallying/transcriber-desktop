...
- **Asset:** исполняемый код приложения и доверие пользователя к установленной
  версии.
- **Threat:** подмена источника, недоверенный или повреждённый ответ,
  несанкционированная установка и потеря доступности сети.
- **Trust boundary:** установленный Client ↔ сервис проверки и источник
  обновления.
- **Control / Implementation / Verification:** не выбраны. Перед реализацией
  должны быть зафиксированы отправляемые данные, получаемые метаданные и файлы,
  доверенный источник, аутентичность и целостность обновления, пользовательское
  управление установкой, offline-поведение и обработка ошибки или
  недоверенного результата.
